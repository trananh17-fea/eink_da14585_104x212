...
const struct attm_desc_128 custs1_att_db[CUSTS1_IDX_NB] =
    {
        ...
        [SVC1_IDX_LED_STATE_VAL] = {SVC1_LED_STATE_UUID_128, ATT_UUID_128_LEN, PERM(NTF, ENABLE) | PERM(WR, ENABLE) | PERM(WRITE_REQ, ENABLE),
                                    PERM(RI, ENABLE) | DEF_SVC1_LED_STATE_CHAR_LEN, 0, NULL},
        //    DEF_SVC1_LED_STATE_CHAR_LEN, 0, NULL},
        [SVC1_IDX_LED_STATE_NTF_CFG] = {(uint8_t *)&att_desc_cfg, ATT_UUID_16_LEN, PERM(RD, ENABLE) | PERM(WR, ENABLE) | PERM(WRITE_REQ, ENABLE),
        ...
        [SVC3_IDX_SVC] = {(uint8_t *)&att_decl_svc, ATT_UUID_128_LEN, PERM(RD, ENABLE) | PERM(NTF, ENABLE) | PERM(WR, ENABLE) | PERM(WRITE_REQ, ENABLE),
        ...
        [SVC3_IDX_READ_1_VAL] = {SVC3_READ_VAL_1_UUID_128, ATT_UUID_128_LEN, PERM(RD, ENABLE) | PERM(NTF, ENABLE) | PERM(WR, ENABLE) | PERM(WRITE_REQ, ENABLE),
